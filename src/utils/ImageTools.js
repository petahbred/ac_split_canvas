...
class ImageTools {
  constructor() {
    this.draw = new DrawingTool();
    this.title = this.draw.title;
    this.creator = this.draw.creator;
    this.town = this.draw.town;
  }

  get title() {
    return this.draw.title;
  }

  set title(value) {
    this.draw.title = value;
  }

  get creator() {
    return this.draw.creator;
  }

  set creator(value) {
    this.draw.creator = value;
  }

  get town() {
    return this.draw.town;
  }

  set town(value) {
    this.draw.town = value;
  }
